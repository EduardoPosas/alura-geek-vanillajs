import"./style-e05a32fb.js";import{b as w,a as b}from"./ProductService-4ab90952.js";const y=async()=>{const t=new URL(window.location.href).searchParams.get("id");console.log(t),t||(window.location.href="/");const o=await w(t);o||(window.location.href="/"),console.log(o);const{name:c,price:i,description:r,imageUrl:s,category:a,id:l}=o,n=document.querySelector("[data-product-description]"),d=`
